...
description: Design multi-agent AI systems and workflows Use when: Building AI-powered products; Adding AI capabilities to existing products; Evaluating AI solutions; Managing AI product roadmap.
---

# AI Agent Orchestration

## Description
Design multi-agent AI systems and workflows
...
As an AI Product Manager, understanding ai agent orchestration is critical for success in the rapidly evolving AI landscape.
